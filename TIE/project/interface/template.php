<?php
    ...
    if ( ! class_exists( __NAMESPACE__ . 'TIE_Template' ) ) {
        ...
        abstract class TIE_Template extends TIE_Interface {
            ...
            public function build_and_render( $shell, $view, $data ) {
                ...
                $generic_shell = GILAD_TIE . '/defaults/classes/shells/class-shell-sitewide.php';
                $public_shell  = get_stylesheet_directory() . '/public/classes/shells/class-shell-' . $shell . '.php';
                $tie_shell     = GILAD_TIE . '/defaults/classes/shells/class-shell-' . strtolower( $shell ) . '.php';
            ...
            protected function shortcodes() {
                ...
                add_shortcode( 'gilad_search_type_zero', 'get_search_form' );
            ...
            public function gilad_html_begin()                 { do_action( 'gilad_html_begin' );                 }

            public function gilad_html_end()                   { do_action( 'gilad_html_end' );                   }
            ...
            public function gilad_between_main_and_footer()    { do_action( 'gilad_between_main_and_footer' );    }

            public function gilad_between_main_and_header()    { do_action( 'gilad_between_main_and_header' );    }
            ...
            public function gilad_footer_main()                { do_action( 'gilad_footer_main' );                }

            public function gilad_header_main()                { do_action( 'gilad_header_main' );                }
