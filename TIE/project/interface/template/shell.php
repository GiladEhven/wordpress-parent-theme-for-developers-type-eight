<?php
    ...
    if ( ! class_exists( __NAMESPACE__ . 'TIE_Shell' ) ) {
        ...
        abstract class TIE_Shell extends TIE_Template {
            ...
            public function get_view( $data ) {
                ...
                $generic_view = GILAD_TIE . '/defaults/classes/views/class-view-0.php';
                $public_view  = get_stylesheet_directory() . '/public/classes/views/class-view-' . $view;
                $tie_view     = GILAD_TIE . '/defaults/classes/views/class-view-' . $view;
                ...
                if ( class_exists( $view_object) ) $view = new $view_object( $data );
