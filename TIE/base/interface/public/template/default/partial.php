        ...
        abstract class TIE_Partial extends TIE_Default {
            ...
            public function build_footer() {
                ...
                ?>
                                ...
                                <!--  ----------------------------------------------------------------------------------------------------------------------------
                                --------------------------  START TIE BASE: INTERFACE / PUBLIC / TEMPLATE / DEFAULT / PARTIAL (footer)  --------------------------
                                -----------------------------------------------------------------------------------------------------------------------------  -->
                    ...
                    <!--  ----------------------------------------------------------------------------------------------------------------------------
                    ---------------------------  END TIE BASE: INTERFACE / PUBLIC / TEMPLATE / DEFAULT / PARTIAL (footer)  ---------------------------
                    -----------------------------------------------------------------------------------------------------------------------------  -->
            ...
            public function build_header() {
                ...
                ?>
                    ...
                    <!--  ----------------------------------------------------------------------------------------------------------------------------
                    --------------------------  START TIE BASE: INTERFACE / PUBLIC / TEMPLATE / DEFAULT / PARTIAL (header)  --------------------------
                    -----------------------------------------------------------------------------------------------------------------------------  -->
                    ...
                    <html <?php language_attributes(); ?>>
                        ...
                        <body <?php body_class(); ?>>
                            ...
                            <div id="body">
                                ...
                                <!--  ----------------------------------------------------------------------------------------------------------------------------
                                ---------------------------  END TIE BASE: INTERFACE / PUBLIC / TEMPLATE / DEFAULT / PARTIAL (header)  ---------------------------
                                -----------------------------------------------------------------------------------------------------------------------------  -->
